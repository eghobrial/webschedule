 ...
 *
 */
public class proposalstatus extends BasePO
{
  private static String PROPOSAL_ID = "proposalID";
    ...
    {
       String temps = "showcomments.po?event=showcomments&Proj_id="+proj_id;
       return temps;
     }
   ...
   public String buildhref (String proj_id)
    ...
    {
        proposalstatusHTML page = new proposalstatusHTML();
	int today ,month ,year;
	String	aproj_name , proj_id, comments,hreftxt,hreftxtc;
	int	status ;
	String cdate;
String statuscode[] = {"Editable","Submitted","Committe Comments","Approved","Accounts Added"};
   ...
   //     templateOption.removeAttribute("id");
	 ...
	 //   HTMLElement commentsCellTemplate = page.getElementComments();
	   ...
	   // aprojnameCellTemplate.removeAttribute("id");
		...
		cdate = Integer.toString(year)+"-"+Integer.toString(month)+"-"+Integer.toString(today);
...
System.out.println(" **** Current proposal  aproj_name off proposalstatus ****"+ aproj_name);
			...
			Element link = page.getElementById("Aproj_id");
	...
	System.out.println(" **** Hi after setting txt off proposalstatus ****");		
	 ...
	 System.out.println(" **** Current proposal  comments off proposalstatus ****"+ comments);		
			...
			Element link1 = page.getElementById("Comments");
