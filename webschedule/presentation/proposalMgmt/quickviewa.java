 ...
 *
 */
public class quickviewa extends BasePO
{
 ...
 public String handleQuickview()
	...
	try
	{
	  ...
	  this.setProposalID(proj_id);
            throw new ClientPageRedirectException(QUICKVIEWA_PAGE);
	     	}   
	    } catch (Exception ex) {
	...
	Date iacucdate;
     ...
     int subtoday ,submonth ,subyear;
      String cdate;
        ...
        quickviewaHTML page = new quickviewaHTML();
	Person thePerson ;
	String personID;
