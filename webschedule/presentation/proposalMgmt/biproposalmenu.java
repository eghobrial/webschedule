 ...
 *
 */
public class biproposalmenu extends BasePO
{
    ...
    {
        biproposalmenuHTML page = new biproposalmenuHTML();
 ...
 public String handleAddaflag()
     throws webschedulePresentationException, HttpPresentationException
    {	
    System.out.println(" **** ADD Proposal has been visited from managment page ****");
    this.setPropFlag("Addabi");
    this.setPbookmark("animal");
         throw new ClientPageRedirectException(NEWPROPOSALP1A_PAGE);
     }
