 ...
 *
 */
public class proposalp4 extends BasePO
{
...
/*     
  ...
  */   
  /* currently 7T only
    ...
    */
        proposalp4HTML page = new proposalp4HTML();
...
try {	
 ...
 String icyears = Integer.toString(icyeari);
	...
	for (int i=0; i< startyear_optionlen; i++) {
     ...
     if (endyeari > 2000)
     {
     System.out.println("End year from with the if statment "+Integer.toString(endyeari));
...
/* 7T only	
	...
	Node    biohazardText = page.getElementBiohazard().getOwnerDocument().createTextNode(biohazard);  
	    ...
	    Node    biohazardText = page.getElementBiohazard().getOwnerDocument().createTextNode(proposal.getBioHazard());  
                page.getElementBiohazard().appendChild(biohazardText);
            }
	*/
	...
	Node    dataanalysisText =page.getElementDataanalysis().getOwnerDocument().createTextNode(proposal.getDataanalysis());	
	           page.getElementDataanalysis().appendChild(dataanalysisText);    
...
/* 7T only	
	...
	Node    animalq1Text =page.getElementAnimalq1().getOwnerDocument().createTextNode(proposal.getAnimalq1());	
	           page.getElementAnimalq1().appendChild(animalq1Text);    
	...
	Node    animalq2Text =page.getElementAnimalq2().getOwnerDocument().createTextNode(proposal.getAnimalq2());	
	           page.getElementAnimalq2().appendChild(animalq2Text);    
	...
	Node    animalq3Text =page.getElementAnimalq3().getOwnerDocument().createTextNode(proposal.getAnimalq3());	
	           page.getElementAnimalq3().appendChild(animalq3Text);    
	...
	Node    animalq4Text =page.getElementAnimalq4().getOwnerDocument().createTextNode(proposal.getAnimalq4());	
	           page.getElementAnimalq4().appendChild(animalq4Text);    
...
if(null != proposalq1 && proposalq1.length() != 0) {
	...
	Node    proposalq1Text =page.getElementProposalq1().getOwnerDocument().createTextNode(proposal.getProposalq1());	
	           page.getElementProposalq1().appendChild(proposalq1Text);    
...
if(null != proposalq2 && proposalq2.length() != 0) {
	...
	Node    proposalq2Text =page.getElementProposalq2().getOwnerDocument().createTextNode(proposal.getProposalq2());	
	           page.getElementProposalq2().appendChild(proposalq2Text);    
	...
	Node    proposalq3Text =page.getElementProposalq3().getOwnerDocument().createTextNode(proposal.getProposalq3());	
	           page.getElementProposalq3().appendChild(proposalq3Text);    
	...
	Node    proposalq4Text =page.getElementProposalq4().getOwnerDocument().createTextNode(proposal.getProposalq4());	
	           page.getElementProposalq4().appendChild(proposalq4Text);    
	...
	Node    proposalq5Text =page.getElementProposalq5().getOwnerDocument().createTextNode(proposal.getProposalq5());	
	           page.getElementProposalq5().appendChild(proposalq5Text);    
	...
	Node    proposalq6Text =page.getElementProposalq6().getOwnerDocument().createTextNode(proposal.getProposalq6());	
	           page.getElementProposalq6().appendChild(proposalq6Text);    
	...
	Node    proposalq7Text =page.getElementProposalq7().getOwnerDocument().createTextNode(proposal.getProposalq7());	
	           page.getElementProposalq7().appendChild(proposalq7Text);    
	...
	Node    proposalq8Text =page.getElementProposalq8().getOwnerDocument().createTextNode(proposal.getProposalq8());	
	           page.getElementProposalq8().appendChild(proposalq8Text);    
...
/*
  ...
  /*      // if some fields are empty, generate error and redirect to this PO
     ...
     // if some fields are empty, generate error and redirect to this PO
	    if (thours.length() == 0 || writeup.length() ==0 ||  dataanalysis.length() == 0 ) {
