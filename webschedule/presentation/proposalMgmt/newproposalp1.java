 ...
 *
 */
public class newproposalp1 extends BasePO
{
 ...
 /**
        ...
        throws HttpPresentationException
    {
      ...
      public String  handleAddbiflag()
     throws webschedulePresentationException, HttpPresentationException
    {	
    System.out.println(" **** ADD Proposal has been visited from managment page bookmark set to humanbi ****");
    this.setPropFlag("Addhbi");
    this.setPbookmark("humanbi");
        throw new ClientPageRedirectException(NEWPROPOSALP1_PAGE);
     }

   public String  handleAddnsflag()
     throws webschedulePresentationException, HttpPresentationException
    {	
    System.out.println(" **** ADD Proposal has been visited from newproposalp1 bookmark set to humanns ****");
    this.setPropFlag("Addhns");
    this.setPbookmark("humanns");
        throw new ClientPageRedirectException(NEWPROPOSALP1_PAGE);
     }
	...
	String piname=null;
        ...
        newproposalp1HTML page = new newproposalp1HTML();
	HTMLScriptElement script = new newproposalScriptHTML().getElementRealScript();
...
String pbookmark = this.getPbookmark();
System.out.println("Book mark flag is "+pbookmark);

//theProposal.setBookmark("humanns");
theProposal.setBookmark(pbookmark);

    System.out.println(" trying to saving a proposal two, bookmark set to humanns "+ proj_name);
	        theProposal.save();	
