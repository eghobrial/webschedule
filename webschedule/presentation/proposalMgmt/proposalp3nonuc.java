...
/**
 * proposalp3.java shows the Proposal Menu Options
 *
 */
public class proposalp3nonuc extends BasePO
{
/**
 * Constants
 *
 **/
    ...
    String fpemail = this.getComms().request.getParameter(FPEMAIL);
       ...
       proposalp3nonucHTML page = new proposalp3nonucHTML();
	...
	String pbookmark;
	  ...
	  try {
	    ...
	    isucsd = theproposal.Isucsd();
	      ...
	      throw new ClientPageRedirectException(PROPOSALP4_PAGE);
	    else 
	      throw new ClientPageRedirectException(PROPOSALP4A_PAGE);
