 ...
 *
 */
public class newproposalmenu extends BasePO
{
    ...
    {
        newproposalmenuHTML page = new newproposalmenuHTML();
	...
	System.out.println(" **** Proposal Submitted has been visited ****"+ proposalID);	
	  try {
	    ...
	    sendemail (theproposal);
	      throw new ClientPageRedirectException(NEWPROPOSALMENU_PAGE);
