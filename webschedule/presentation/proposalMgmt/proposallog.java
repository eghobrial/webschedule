 ...
 *
 */
public class proposallog extends BasePO
{
...
public String buildvcomhref (String proj_id)
  ...
  public String buildhref (String proj_id)
    ...
    System.out.println(" **** Hi after set href off proposal log my book is****"+bookmark);
...
System.out.println(" **** Current proposal  aproj_name off proposalstatus ****"+ aproj_name);
	...
	System.out.println(" **** Hi after setting txt off proposalstatus ****");
			...
			String 	sendcomments = "View Comments";	
			Element link1 = page.getElementById("Commentsres");
