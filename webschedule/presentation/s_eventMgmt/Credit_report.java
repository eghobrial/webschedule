 ...
 *
 */
public class Credit_report extends BasePO
{
   /*
   * Constants
   */
   ...
   /* private static String SDATE ="sdate";
    ...
    {
    	Credit_reportHTML page = new Credit_reportHTML();
...
/*    	this.setbillsday(billsdate);
	...
	if (null == ReporttrackFactory.findReporttrackForMonth(billyear,billmonth,0))
	 ...
	 report.setReportinfo(0);
	 report.save();
	 throw new ClientPageRedirectException(CREDIT_PILOT_HOURS_PAGE);	
	 } else {
return showPage("The pilot hours for month " + month + " year "+year+" has been credited");    
	        }
