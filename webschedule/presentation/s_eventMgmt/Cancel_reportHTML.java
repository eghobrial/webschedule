...
public class Cancel_reportHTML extends org.enhydra.xml.xmlc.html.HTMLObjectImpl {
    /**
     * Field that is used to identify this as an XMLC
     * generated class.  Contains an reference to the
     * class object.
     */
    public static final Class XMLC_GENERATED_CLASS = Cancel_reportHTML.class;

    /**
     * Field containing CLASSPATH relative name of the source file
     * that this class was generated from.
     */
    public static final String XMLC_SOURCE_FILE = "webschedule/presentation/s_eventMgmt/Cancel_report.html";

    /**
     * Element name constant for event2
     */
    public static final String NAME_event2 = "event2";
    /**
     * Element name constant for Cancellation
     */
    public static final String NAME_Cancellation = "Cancellation";
    /**
    ...
    public static final String NAME_submit = "submit";
    /**
     * Element name constant for month
     */
    public static final String NAME_month = "month";
    /**
     * Element name constant for LogoutForm
     */
    public static final String NAME_LogoutForm = "LogoutForm";
    /**
    ...
    /**
     * Get the element with id <CODE>Month</CODE>.
     * @see org.w3c.dom.html.HTMLSelectElement
     */
    public org.w3c.dom.html.HTMLSelectElement getElementMonth() {
        return $elementMonth;
    }
    private org.w3c.dom.html.HTMLSelectElement $elementMonth;
    ...
    public void buildDocument() {
        ...
        $node3 = document.createTextNode("Cancellation Report");;
        ...
        $node6 = document.createTextNode("Cacellation Report");;
        ...
        $node6 = document.createTextNode("Cancel_report.po");;
        $attr5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Cancellation");;
        $attr5.appendChild($node6);
        ...
        $node9 = document.createTextNode("Month");;
        $elem8.appendChild($node9);
        ...
        $elementMonth = (org.w3c.dom.html.HTMLSelectElement)$elem9;
        $attr9 = document.createAttribute("id");
        $elem9.setAttributeNode($attr9);
        
        $node10 = document.createTextNode("Month");;
        ...
        $node10 = document.createTextNode("Generate Cancellation Report");;
        $attr9.appendChild($node10);
        ...
        $node5 = document.createTextNode("68");;
        $attr4.appendChild($node5);
        ...
        $elem5 = document.createElement("HR");;
        $elem4.appendChild($elem5);
        
        $node5 = document.createTextNode("Back to the ");;
        $elem4.appendChild($node5);
        
        $elem5 = document.createElement("A");;
        $elem4.appendChild($elem5);
        
        $attr5 = document.createAttribute("href");
        $elem5.setAttributeNode($attr5);
        
        $node6 = document.createTextNode("Admin.html");;
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Admin Main Menu");;
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("Admin_Login.html");;
        $attr5.appendChild($node6);
        
        $node6 = document.createTextNode("Admin Login Page");;
        $elem5.appendChild($node6);
        ...
        $node6 = document.createTextNode("../personMgmt/Login.po?event=logout");;
        $attr5.appendChild($node6);
        ...
        $node6 = document.createTextNode("LogoutForm");;
        $attr5.appendChild($node6);
        
        $elem6 = document.createElement("INPUT");;
        $elem5.appendChild($elem6);
        
        $attr6 = document.createAttribute("name");
        $elem6.setAttributeNode($attr6);
        
        $node7 = document.createTextNode("event2");;
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttribute("type");
        $elem6.setAttributeNode($attr6);
        
        $node7 = document.createTextNode("HIDDEN");;
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttribute("value");
        $elem6.setAttributeNode($attr6);
        
        $node7 = document.createTextNode("logout");;
        $attr6.appendChild($node7);
        ...
        $node7 = document.createTextNode("../media/Logout_button.jpg");;
        $attr6.appendChild($node7);
        
        $attr6 = document.createAttribute("type");
        $elem6.setAttributeNode($attr6);
        
        $node7 = document.createTextNode("image");;
        $attr6.appendChild($node7);
    ...
    protected void syncWithDocument(Node node) {
        if (node instanceof Element) {
            ...
            if (id.length() == 0) {
                ...
                $elementMonth = (org.w3c.dom.html.HTMLSelectElement)node;
     ...
     */
    public Cancel_reportHTML(boolean buildDOM) {
        if (buildDOM) {
            buildDocument();
        }
    }
     ...
     */
    public Cancel_reportHTML(Cancel_reportHTML src) {
    ...
    public Node cloneNode(boolean deep) {
        cloneDeepCheck(deep);
        return new Cancel_reportHTML(this);
    }
